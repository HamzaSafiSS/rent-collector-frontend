    ...
    <PortalLayout navItems={NAV} portalLabel="Admin">
      ...
      >
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <Input label="Action"    name="action"     value={filters.action}     onChange={(e) => setFilters((p) => ({ ...p, action: e.target.value }))}     placeholder="e.g. LEASE_CREATED" />
          <Input label="Entity Type" name="entityType" value={filters.entityType} onChange={(e) => setFilters((p) => ({ ...p, entityType: e.target.value }))} placeholder="e.g. PAYMENT" />
