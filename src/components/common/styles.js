...
// Button variant classes — Dual Mode (Light default + Dark override)
export const buttonVariants = {
  ...
  danger: `
    ...
    border border-transparent
    focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-slate-900
    disabled:opacity-50 disabled:cursor-not-allowed
    transition-colors duration-150
  `,
  ghost: `
    bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 active:bg-slate-200 dark:active:bg-slate-700
...
// Badge variant classes — Dual Mode
export const badgeVariants = {
  ...
  info:    'bg-sky-500/15 text-sky-700 dark:text-sky-400 border border-sky-500/25',
  neutral: 'bg-slate-500/15 text-slate-600 dark:text-slate-400 border border-slate-500/25',
};

// Input shared classes — Dual Mode
export const inputBase = `
  w-full px-3 py-2 text-sm
  text-slate-800 dark:text-slate-100
  bg-slate-50 dark:bg-slate-800/60 backdrop-blur-sm
  border border-slate-300 dark:border-slate-600/50 rounded-xl shadow-sm
  [color-scheme:light] dark:[color-scheme:dark]
  placeholder-slate-400 dark:placeholder-slate-500
  focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:bg-white dark:focus:bg-slate-800 focus:border-emerald-500/50
  disabled:bg-slate-100 dark:disabled:bg-slate-800/30 disabled:text-slate-400 dark:disabled:text-slate-500 disabled:cursor-not-allowed
  transition-all duration-200
`;
